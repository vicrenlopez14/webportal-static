...
class MessagesApi {
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Message>> getMessage({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [Message] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<Message>> postMessage({ 
    Message? message,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    try {
      ...
      _bodyData = message == null ? null : _serializers.serialize(message, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> putMessage({ 
    required String id,
    Message? message,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
