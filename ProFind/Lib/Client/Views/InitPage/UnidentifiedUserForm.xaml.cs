        ...
        void ButtonClickHomeMethod()
        {
            ...
            switch (mail)
            {
                case "admin@profind.work":
                    new GlobalNavigationController().NavigateTo(typeof(Admin.Views.Main_Page_Admin.Main_Page_Admin));
                    break;
                ...
                case "client@profind.work":
                    new GlobalNavigationController().NavigateTo(typeof(Client.Views.Main_Page.Main_Page_Client));
                    break;
                default:
                    new GlobalNavigationController().NavigateTo(typeof(Client.Views.Main_Page.Main_Page_Client));
                    break;
